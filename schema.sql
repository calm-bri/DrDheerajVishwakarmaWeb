...
('sc-rp-news', 'Rajasthan Patrika: Stitch-less Spine Care', 'Pioneering <8mm single-stitch ambulatory endoscopic spine surgeries.', 'Special press release documenting the benefits of under-8mm stitch-less endoscopic surgery, explaining how avoiding muscle tears leads to same-day recovery milestones.', 'news', 'India Desk', 'August 2025', 'https://images.unsplash.com/photo-1585829365295-ab7cd400c167?auto=format&fit=crop&w=1200&q=80', NULL, 'md:col-span-1 md:row-span-1 aspect-square sm:aspect-auto', 'Single Stitch (<8mm)'),
...
('sc-1', 'Dual-Portal Endoscopic Operating Suite Setup', 'High-definition camera consoles & saline Continuous Pressure irrigation system.', 'The main operating desk showing full-endoscopic spinal camera integration, dual continuous-flow pump nodes, and micro-manipulators. Keeping the incision under 7mm ensures absolute safety.', 'surgical', 'Surgical Theatre Unit A, India', 'May 2026', 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?auto=format&fit=crop&w=1200&q=80', 'https://www.w3schools.com/html/mov_bbb.mp4', 'md:col-span-2 md:row-span-1 aspect-[16/10] sm:aspect-auto', 'Featured Room'),
('sc-2', 'Post-Operative Recovery Patient Assessment', 'Real-time neuro-pathway validation while the patient is awake.', 'Dr. Dheeraj Vishwakarma performing active motor checks immediately following a stitch-less transforaminal decompression. The patient walked independently within 3 hours.', 'surgical', 'Special Care Ward', 'April 2026', 'https://images.unsplash.com/photo-1584515979956-d9f6e5d09982?auto=format&fit=crop&w=800&q=80', NULL, 'md:col-span-1 md:row-span-1 aspect-square sm:aspect-auto', 'Awake Technique'),
...
('sc-6', 'National Media Spotlight on Stitch-Less Interventions', 'Special front-page feature covering the clinical shift to outpatient spine solutions.', 'An extensive interview piece detailing how endoscopic micro-discectomies drastically lower risk variables for elderly patients with cardiovascular complex histories.', 'news', 'Times Medical Focus Edition', 'April 2026', 'https://images.unsplash.com/photo-1504711434969-e33886168f5c?auto=format&fit=crop&w=1200&q=80', NULL, 'md:col-span-2 md:row-span-1 aspect-[16/10] sm:aspect-auto', 'Press Cover'),
...
VALUES
('test-1', 'Manoj Kumar Sharma', 'Jaipur, Rajasthan (Google Verified Review)', 'L4-L5 Slipped Disc with Severe Sciatica', 'I suffered from unbearable back and leg pain due to L4-L5 herniation for 6 months. Dr. Dheeraj diagnosed it perfectly and performed an endoscopic keyhole surgery. I walked on the same day within 2 hours. He is truly the best endoscopic spine doctor in Jaipur! Thank you, doctor, for giving me my life back.', 'Walked 2 hours post-op, discharged within 24h', 5),
('test-2', 'Preeti Vyas', 'Ajmer, Rajasthan (Google Verified Review)', 'Severe Cervical Spondylosis & Hand Numbness', 'Others suggested open spinal fusion which was scary. Dr. Dheeraj Vishwakarma treated my neck issue endoscopically with a tiny 7mm cut. The hand numbness and shooting pain disappeared instantly. No fusion, no implants. Highly recommended!', 'Discharged next morning, back to work in 5 days', 5),
...
VALUES
('faq-1', 'What is the difference between Endoscopic Spine Surgery and traditional spine surgery?', 'Traditional spine surgery requires a large incision of 3-5 inches, severe cutting and peeling of spine muscles, and a long hospital stay. Dr. Vishwakarma''s Endoscopic Spine Surgery uses a tiny incision (~7mm, less than a finger-width), passes between muscles without ripping them, preserves the spinal joints, and allows patients to walk comfortably within hours afterward.', 'technology'),
