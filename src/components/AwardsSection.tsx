...
const PREMIUM_AWARDS: SpecialAward[] = [
  {
    ...
    summary: "Achieved the first Monoportal Endoscopic Spine Surgery in the State of Rajasthan.",
  ...
  },
  {
    ...
    summary: "Operated on the youngest Cauda Equina patient, recognized by the India Book of Records & Asia Book of Records.",
  ...
  },
  {
    ...
    summary: "Performed the first Cervical Monoportal Endoscopic Discectomy in Jaipur & Rajasthan and Performed the first Dorsal Monoportal Endoscopic Discectomy in Jaipur & Rajasthan.",
  ...
  },
  {
    ...
    summary: "Trained under Dr. Sukumar Sura, a leading authority in endoscopic spine surgery.",
